namespace BridgeSystems.Bridgemate.DataConnector.ScoringProgramClient
{
    ...
    public enum ScoringProgramDataConnectorCommands
    {
        ...
        /// </summary>
        PutBridgemate3Settings=15,                 //Bridgemate3SettingsDTOO[]

        /// <summary>
        /// Not supported
        /// </summary>
        UpdateSession,                     //Not supported
        ...
        /// </summary>
        PollQueueForNewPlayerData=20,              //ReturnsPlayerDataDTO

        /// <summary>
        /// Query the Data Connector for new participations.
        /// </summary>
        PollQueueForNewParticipations,     //ReturnsParticipationDTO[]
        ...
        /// </summary>
        PollQueueForAllParticipations=25,          //Returns ParticipationDTO[]

        /// <summary>
        /// Request all handrecords for the session from the Data Connector.
        /// </summary>
        PollQueueForAllHandrecords,        //Returns HandrecordDTO[]
